...
namespace TCP_server_test {
	...
	/// </summary>
	public ref class ServerForm : public System::Windows::Forms::Form, ManagedServerSockControllerInterface
	{
	public:
		ServerForm(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnStart->Click += gcnew System::EventHandler(this, &ServerForm::btnStart_Click);
			// 
			// tbPort
			// 
...
#pragma region MyCode
	...
	private: void afterStartServer(){
				 if (this->ServerStatusLabel->InvokeRequired){
					 afterStartServerDelegate^ d = gcnew afterStartServerDelegate(this, &ServerForm::afterStartServer);
					 this->Invoke(d);
				 }
				 else {
	...
	public: void onServerSockLog(std::string className, std::string funcName, std::string msg) override;
	public: void onServerSockError(std::string className, std::string funcName, std::string msg) override;
