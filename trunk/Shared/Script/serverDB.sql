...
CREATE TABLE [dbo].[Files](
	...
	[FileChecksum] [nvarchar](max) NOT NULL,
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[VersionFiles](
	[VerID] [int] NOT NULL,
	[UserID] [int] NOT NULL,
	[FileID] [int] NOT NULL,
 CONSTRAINT [PK_VersionFiles] PRIMARY KEY CLUSTERED 
(
	[VerID] ASC,
	[UserID] ASC,
	[FileID] ASC
...
GO
ALTER TABLE [dbo].[VersionFiles]  WITH CHECK ADD  CONSTRAINT [FK_VersionFiles_Files] FOREIGN KEY([FileID])
REFERENCES [dbo].[Files] ([FileID])
ON UPDATE CASCADE
ON DELETE CASCADE

GO
ALTER TABLE [dbo].[VersionFiles] CHECK CONSTRAINT [FK_VersionFiles_Files]

GO
ALTER TABLE [dbo].[VersionFiles]  WITH CHECK ADD  CONSTRAINT [FK_VersionFiles_Versions] FOREIGN KEY([VerID], [UserID])
REFERENCES [dbo].[Versions] ([VerID], [UserID])
ON UPDATE CASCADE
ON DELETE CASCADE

GO
ALTER TABLE [dbo].[VersionFiles] CHECK CONSTRAINT [FK_VersionFiles_Versions]
